...
extension UIImage {
  static func plushPadlockCircle1(color: UIColor, size: CGSize = CGSize(width: 48.0, height: 48.0)) -> UIImage {
    let f = UIGraphicsImageRendererFormat.preferred()
    f.opaque = false
    let scale = CGSize(width: size.width / 48.0, height: size.height / 48.0)
    return UIGraphicsImageRenderer(size: size, format: f).image {
      drawPlushPadlockCircle1(in: $0.cgContext, scale: scale, color: color)
    }
  }

  private static func drawPlushPadlockCircle1(in ctx: CGContext, scale: CGSize, color: UIColor) {
    ...
    path.addLine(to: CGPoint(x: 36.3, y: 20.11))
    path.addCurve(to: CGPoint(x: 41.5, y: 31.5),
                   control1: CGPoint(x: 39.5, y: 22.99),
                   control2: CGPoint(x: 41.5, y: 27))
    ...
    path.closeSubpath()
    path.move(to: CGPoint(x: 28.71, y: 10.81))
    path.addLine(to: CGPoint(x: 29.01, y: 16.17))
    path.addCurve(to: CGPoint(x: 24, y: 15.5),
                   control1: CGPoint(x: 27.42, y: 15.73),
                   control2: CGPoint(x: 25.73, y: 15.5))
    path.addCurve(to: CGPoint(x: 18.99, y: 16.17),
                   control1: CGPoint(x: 22.27, y: 15.5),
                   control2: CGPoint(x: 20.58, y: 15.73))
    path.addLine(to: CGPoint(x: 19.29, y: 10.81))
    path.addCurve(to: CGPoint(x: 22.78, y: 7.5),
                   control1: CGPoint(x: 19.39, y: 8.95),
                   control2: CGPoint(x: 20.93, y: 7.5))
    path.addLine(to: CGPoint(x: 25.22, y: 7.5))
    path.addCurve(to: CGPoint(x: 28.71, y: 10.81),
                   control1: CGPoint(x: 27.07, y: 7.5),
                   control2: CGPoint(x: 28.61, y: 8.95))
    path.closeSubpath()
